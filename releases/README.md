...
- **CD audio by ear (the user, 2026-09-17):** a game with CD audio played
  on this bitstream with the Main binary above, and the audio was heard.
  The first sound ever confirmed from the core's CD-DA path (the engine's
  44.1 kHz cadence fed by Main's 75 Hz next-frame window).

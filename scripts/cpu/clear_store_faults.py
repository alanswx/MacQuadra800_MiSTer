#!/usr/bin/env python3
"""Check precise CLR faults, flags, and address-register rollback."""
import argparse
...
"""
 ...
 print(name,'PASS',next(l for l in log.splitlines() if l.startswith('CLR_EA')),flush=True)

  ...
  if(pending) begin
   ...
   if(waitleft>0) waitleft<=waitleft-1;
    ...
    if(saved_wr && saved_addr==32'hf102) begin
     ...
     if(mem['h2022>>1]!==16'h4005 || mem['h2024>>1]!==16'hcc00 || mem['h2026>>1]!==0 || mem['h2028>>1]!==0 || mem['h202a>>1]!==0) $fatal(1,"SANE result mismatch");
     if(mem['h2002>>1]!==16'h3fff || mem['h2004>>1]!==16'h8000 || mem['h2006>>1]!==0 || mem['h2008>>1]!==0 || mem['h200a>>1]!==0) $fatal(1,"SANE source changed");
     if(mem['h2000>>1]!==16'ha55a || mem['h2020>>1]!==16'ha55a || mem['h200c>>1]!==16'h5aa5 || mem['h202c>>1]!==16'h5aa5) $fatal(1,"SANE guards changed");

...
| build 6 (c84a5e7: + fast_hit tests !snoop_wr instead of !inv_wren and compares the snoop row against the registered hint's set; cycle-identical) | seed 21 + the switch, launched 19:29, log `../MacQuadra800_wt3/scratch/build_b6_s21r.log` |
...
1. Build 6's result: if it fits and meets timing, copy the rbf to

...
| build 11 | 83ab536, the head (+ 14 reads passing a queued store, + 15 BRA.B from any retire) | 21 + the switch | (compiling, wait-gated behind another session's flow) | | | after build 10's run |

...
Combined P154/P151 Whetstone completes25,410,399/25,411,027 cycles,79,992 extra loop cycles (0.316%) versus P154/P136. Root verified all three captures, non-cache identities and source hashes (`scratch/whetstone_full_p154_p151_20260921/root_audit.txt`). Together with unchanged Dhrystone and full integration, the smaller-RAM candidate has quantified simulation tradeoffs; actual RAM savings/fit/timing still need Quartus.

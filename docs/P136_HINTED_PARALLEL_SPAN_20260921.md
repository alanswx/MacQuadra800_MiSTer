...
Fit completed: 40,228 ALMs, 502 RAM blocks, 42 DSPs; fresh RBF SHA256 c0ad8b4c14f82038ddee2e279c7359b77278390f6306e5ece2cdc492b7a93aad. CPU setup -5.481 ns, HDMI -0.373 ns, RAM +0.448 ns, cross sys-to-RAM +1.163 ns and RAM-to-sys +0.395 ns. Root verified build.exit=1 (timing failure), cross.exit=0, cpu_timing.exit=0, source_check_after.exit=0 and terminal wrapper. The earlier agent summary incorrectly reported report-stage failures; both report stages succeeded. No deployment. P147 targets the measured late request-qualified data mux path before another fit.
